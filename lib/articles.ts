...
per-zone OCR                   1.000  0.778        0.679  0.630  0.481`,
  ...
  },
  {
    ...
    metaDescription:
      "27 calls, same model. The CLI bills the subscription while printing the API-equivalent cost, and one env var can silently bill the wrong account.",
  ...
  },
  {
    ...
    metaDescription:
      "Two years inside a procurement fintech: the demo sells, the contract signs, then setup drags for weeks. What cut onboarding time by 90 percent.",
  ...
  },
  {
    ...
    metaDescription:
      "41 researched rules across 10 domains, applied by an agent whose second pass tries to refute its own findings. On Medusa it killed 10 of 16 findings.",
...
/fintech-roast:roast`,
  ...
  },
  {
    ...
    metaDescription:
      "Six questions the canvas never asks, from two years shipping an approval workflow engine, and the trade-off we picked: freeze the workflow at init.",
  ...
  },
  {
    ...
    metaTitle: "Deterministic code vs AI agents in payment processing | Dylan Mérigaud",
    metaDescription:
      "A payment decision has to be exact and repeatable. The money logic is deterministic code, the agent only touches the three places judgement is open ended.",
  ...
  },
  {
    ...
    metaDescription:
      "Variable-size nodes break dagre's centering, first paint flickers, and chains render with kinked edges. The why, the fix, and the package that does all three.",
